...
import Taskflier from '../../components/projects/taskflier/taskflier';
import MnbMart from '../../components/projects/mnbMart/mnbMart';
  ...
  return (
    <div className='base' id='projects'>
      <div className='projects'>
        ...
        <div style={{width: "100%"}}><Fade bottom delay={100}><Taskflier/></Fade></div>
        {/* <div style={{width: "100%"}}><Fade bottom delay={100}><Tindog/></Fade></div> */}
        <div style={{width: "100%"}}><Fade bottom delay={100}><MnbMart/></Fade></div>
